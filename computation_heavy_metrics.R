...
readRDS( 'plainSVDreconstruct48perc.rds')->SVD_res48p
# @ UP : list(PC=PC,
#	      X_rec=X_rec,
#	      X_rec_noise=X_rec_noise), 
colnames(SVD_res48p$X_rec)<- colnames(X)
colnames(SVD_res48p$X_rec_noise)<- colnames(X)
