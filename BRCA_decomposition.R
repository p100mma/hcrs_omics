...
gs[[a]]$rec<-get_reconstruction_at_g(X,gs[[a]]$hcluster_blockPCA, gs[[a]]$hclustering_list, g=a) 
}
set.seed(12412)
...
saveRDS(PCmat_cloned_norm, "PCs/PCmat_cloned_norm.rds")
saveRDS(PCmat_orig, "PCs/PCmat_orig.rds")
message('saving R session image')
save.image('afterDecomposition.RData')
